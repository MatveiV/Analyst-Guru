...
const translations = {
  ru: {
    ...
    settings_ai_desc: "Выберите провайдера, модель и параметры для AI-операций.",
  ...
  en: {
    ...
    settings_subtitle: "Manage AI providers, models and API keys.",
    settings_ai_title: "AI Provider",
    settings_ai_desc: "Select provider, model and parameters for AI operations.",
