...
description: How to run Python FastAPI as a service; path gotcha with artifact run commands
---
...
**Why:** The runtime sets CWD to the artifact directory before running the dev command. Using the full path from workspace root causes a doubled path.
